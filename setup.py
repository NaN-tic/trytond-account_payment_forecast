...
PREFIX = 'trytonspain'
MODULE2PREFIX = {'account_payment_type': 'trytonspain', 'account_bank': 'trytonspain', 'jasper_reports': 'trytonspain'}
OWNER = {
    'nantic':'NaN-tic',
    'trytonzz':'nanticzz',
}
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:trytonspain/trytond-account_payment_forecast',
    ...
    project_urls = {
       "Source Code": 'https://github.com:trytonspain/trytond-account_payment_forecast'
    },
    classifiers=[
